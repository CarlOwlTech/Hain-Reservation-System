...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new DateChooserComponent.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new DateChooserComponent.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new DateChooserComponent.Button();
        cmdPrevious = new DateChooserComponent.Button();
        slide = new DateChooserComponent.Slider();
    ...
    private DateChooserComponent.Button cmdForward;
    private DateChooserComponent.Button cmdMonth;
    private DateChooserComponent.Button cmdPrevious;
    private DateChooserComponent.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private DateChooserComponent.Slider slide;
