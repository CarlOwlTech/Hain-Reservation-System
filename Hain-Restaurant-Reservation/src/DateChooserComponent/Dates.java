...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new DateChooserComponent.Button();
        cmdTu = new DateChooserComponent.Button();
        cmdWe = new DateChooserComponent.Button();
        cmdTh = new DateChooserComponent.Button();
        cmdFr = new DateChooserComponent.Button();
        cmdSa = new DateChooserComponent.Button();
        cmdSu = new DateChooserComponent.Button();
        cmd1 = new DateChooserComponent.Button();
        cmd2 = new DateChooserComponent.Button();
        cmd3 = new DateChooserComponent.Button();
        cmd4 = new DateChooserComponent.Button();
        cmd5 = new DateChooserComponent.Button();
        cmd6 = new DateChooserComponent.Button();
        cmd7 = new DateChooserComponent.Button();
        cmd8 = new DateChooserComponent.Button();
        cmd9 = new DateChooserComponent.Button();
        cmd10 = new DateChooserComponent.Button();
        cmd11 = new DateChooserComponent.Button();
        cmd12 = new DateChooserComponent.Button();
        cmd13 = new DateChooserComponent.Button();
        cmd14 = new DateChooserComponent.Button();
        cmd15 = new DateChooserComponent.Button();
        cmd16 = new DateChooserComponent.Button();
        cmd17 = new DateChooserComponent.Button();
        cmd18 = new DateChooserComponent.Button();
        cmd19 = new DateChooserComponent.Button();
        cmd20 = new DateChooserComponent.Button();
        cmd21 = new DateChooserComponent.Button();
        cmd22 = new DateChooserComponent.Button();
        cmd23 = new DateChooserComponent.Button();
        cmd24 = new DateChooserComponent.Button();
        cmd25 = new DateChooserComponent.Button();
        cmd26 = new DateChooserComponent.Button();
        cmd27 = new DateChooserComponent.Button();
        cmd28 = new DateChooserComponent.Button();
        cmd29 = new DateChooserComponent.Button();
        cmd30 = new DateChooserComponent.Button();
        cmd31 = new DateChooserComponent.Button();
        cmd32 = new DateChooserComponent.Button();
        cmd33 = new DateChooserComponent.Button();
        cmd34 = new DateChooserComponent.Button();
        cmd35 = new DateChooserComponent.Button();
        cmd36 = new DateChooserComponent.Button();
        cmd37 = new DateChooserComponent.Button();
        cmd38 = new DateChooserComponent.Button();
        cmd39 = new DateChooserComponent.Button();
        cmd40 = new DateChooserComponent.Button();
        cmd41 = new DateChooserComponent.Button();
        cmd42 = new DateChooserComponent.Button();
    ...
    private DateChooserComponent.Button cmd1;
    private DateChooserComponent.Button cmd10;
    private DateChooserComponent.Button cmd11;
    private DateChooserComponent.Button cmd12;
    private DateChooserComponent.Button cmd13;
    private DateChooserComponent.Button cmd14;
    private DateChooserComponent.Button cmd15;
    private DateChooserComponent.Button cmd16;
    private DateChooserComponent.Button cmd17;
    private DateChooserComponent.Button cmd18;
    private DateChooserComponent.Button cmd19;
    private DateChooserComponent.Button cmd2;
    private DateChooserComponent.Button cmd20;
    private DateChooserComponent.Button cmd21;
    private DateChooserComponent.Button cmd22;
    private DateChooserComponent.Button cmd23;
    private DateChooserComponent.Button cmd24;
    private DateChooserComponent.Button cmd25;
    private DateChooserComponent.Button cmd26;
    private DateChooserComponent.Button cmd27;
    private DateChooserComponent.Button cmd28;
    private DateChooserComponent.Button cmd29;
    private DateChooserComponent.Button cmd3;
    private DateChooserComponent.Button cmd30;
    private DateChooserComponent.Button cmd31;
    private DateChooserComponent.Button cmd32;
    private DateChooserComponent.Button cmd33;
    private DateChooserComponent.Button cmd34;
    private DateChooserComponent.Button cmd35;
    private DateChooserComponent.Button cmd36;
    private DateChooserComponent.Button cmd37;
    private DateChooserComponent.Button cmd38;
    private DateChooserComponent.Button cmd39;
    private DateChooserComponent.Button cmd4;
    private DateChooserComponent.Button cmd40;
    private DateChooserComponent.Button cmd41;
    private DateChooserComponent.Button cmd42;
    private DateChooserComponent.Button cmd5;
    private DateChooserComponent.Button cmd6;
    private DateChooserComponent.Button cmd7;
    private DateChooserComponent.Button cmd8;
    private DateChooserComponent.Button cmd9;
    private DateChooserComponent.Button cmdFr;
    private DateChooserComponent.Button cmdMo;
    private DateChooserComponent.Button cmdSa;
    private DateChooserComponent.Button cmdSu;
    private DateChooserComponent.Button cmdTh;
    private DateChooserComponent.Button cmdTu;
    private DateChooserComponent.Button cmdWe;
